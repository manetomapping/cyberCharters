    ...
    cartodb.createLayer(map, layerUrl_cybers, layerOptions_cybers)
	 ...
	 .on('error', function() {
	  ...
	  .on('featureClick', function(e, latlng, pos, data) {
		...
		$.getJSON("http://manetomapping.cartodb.com/api/v2/sql?q=SELECT labelname, geoid, Total_Exp_Cyber_10, Total_Exp_Cyber_13, PCT_exp_change_10_13, Total_Cyber_10, Total_Cyber_13, Pct_change_10_13, Exp_reg13, Exp_spc13, PCT_enroll_13  FROM cybercharters WHERE labelname ='" +searchstring+ "'&format=json&callback=?", function(data) {
